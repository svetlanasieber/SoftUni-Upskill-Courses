...
password_validation_list = [
    len_password(user_password),
    letters_and_digits(user_password),
    two_or_more_digits(user_password, digits_counter),
]
if (
    password_validation_list[0] is True
    and password_validation_list[1] is True
    and password_validation_list[2] is True
):
